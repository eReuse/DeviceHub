from ereuse_devicehub.resources.event.snapshot.snapshot import Snapshot
...
class SnapshotFile(Snapshot):
    ...
    def get_register_object(self):
        ...
        if data['version'] == 1.0:
            from ereuse_devicehub.resources.event.register.translation1_0 import Translation1_0
